package com.manual.mybatis.aop;
...
import com.manual.mybatis.utils.JDBCUtils;
import com.manual.mybatis.utils.SQLUtils;
...
public class MyInvocationHandlerMybatis implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        //判断方法上是否有ExtInsert注解
        ExtInsert extInsert;
        extInsert = method.getAnnotation(ExtInsert.class);
        if (extInsert != null) {
